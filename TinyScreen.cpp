...
void TinyScreen::drawBitmap(unsigned char *image, uint8_t x, uint8_t y) { 
    uint8_t sizex = image[0];                        // get X size
    uint8_t sizey = image[1];                        // get Y size
